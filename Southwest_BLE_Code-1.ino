/* 
Southwest_LifeJacket_Fimrware
*/
#include <BLE_API.h>

#define DEVICE_NAME       "LJ-A001-9_9_2020-GOOD"
#define DEVICE_NAME_ALERT "LJ-A001-9_9_2020-ALERT"
...
void handle_irq66(void) { 
  ble.setDeviceName((const uint8_t *)DEVICE_NAME_ALERT);
  Serial.print("LJ ALERT Triggered");
}
